...
function(e) {
    ...
    function n(e, s) {
        ...
        if ("string" == typeof e)
            ...
            l += t(e) ? '<a href="' + e + '" class="json-string json-url">"' + e + '"</a>' : '<span class="json-string">"' + e + '"</span>';
        else if ("number" == typeof e)
            l += '<span class="json-literal json-literal-number">' + e + "</span>";
        else if ("boolean" == typeof e)
            l += '<span class="json-literal json-literal-boolean">' + e + "</span>";
        else if (null === e)
            l += '<span class="json-literal json-literal-null">null</span>';
        else if (e instanceof Array)
            if (e.length > 0) {
                l += '[<ol class="json-array">';
                for (var r = 0; r < e.length; ++r)
                    l += "<li>",
                    o(e[r]) && (l += '<a href class="json-toggle"></a>'),
                    l += n(e[r], s),
                    r < e.length - 1 && (l += ","),
                    l += "</li>";
                l += "</ol>]"
            ...
            if (a > 0) {
                ...
                for (var i in e)
                    if (e.hasOwnProperty(i)) {
                        ...
                        l += o(e[i]) ? '<a href class="json-toggle">' + c + "</a>" : c,
                        l += ": " + n(e[i], s),
                        --a > 0 && (l += ","),
                        l += "</li>"
                    }
    ...
    e.fn.jsonViewer = function(t, s) {
        ...
        this.each(function() {
            var l = n(t, s);
            o(t) && (l = '<a href class="json-toggle"></a>' + l),
            e(this).html(l),
            e(this).off("click"),
            ...
            e(this).on("click", "a.json-placeholder", function() {
                return e(this).siblings("a.json-toggle").click(),
                !1
            }),
...
function(e) {
    ...
    n.prototype = {
        ...
        get: function() {
            try {
                return e(".collapsed").click(),
                JSON.parse(this.$container.text().replaceAll("\'","'"))
            } catch (o) {
