...
ace.define("ace/lib/report_error", ["require", "exports", "module"], function(e, t, n) {
...
ace.define("ace/lib/app_config", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/report_error"], function(e, t, n) {
    "no use strict";
    function u(e) {
        typeof console != "undefined" && console.warn && console.warn.apply(console, arguments)
    }
    var r = e("./oop"), i = e("./event_emitter").EventEmitter, s = e("./report_error").reportError, o = {
        ...
        getOption: function(e) {
            ...
            return t ? t.forwardTo ? this[t.forwardTo] && this[t.forwardTo].getOption(e) : t && t.get ? t.get.call(this) : this["$" + e] : u('misspelled option "' + e + '"')
        }
    }, a, f = function() {
        function e() {
            this.$defaultOptions = {}
        ...
        e.prototype.nls = function(e, t) {
            a && !a[e] && u("No message found for '" + e + "' in the provided messages, falling back to default English message.");
            var n = a && a[e] || e;
            return t && (n = n.replace(/\$(\$|[\d]+)/g, function(e, n) {
                return n == "$" ? "$" : t[n]
            })),
            n
        }
...
ace.define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/net", "ace/lib/dom", "ace/lib/app_config", "ace/theme/textmate"], function(e, t, n) {
    "no use strict";
    var r = e("./lib/lang")
      , i = e("./lib/net")
      , s = e("./lib/dom")
    ...
    t.moduleUrl = function(e, t) {
        ...
        var o = u[t + "Path"];
        return o == null ? o = u.basePath : r == "/" && (t = r = ""),
        o && o.slice(-1) != "/" && (o += "/"),
    ...
    ;
    var l = function() {
        !u.basePath && !u.workerPath && !u.modePath && !u.themePath && !Object.keys(u.$moduleUrls).length && (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"),
        l = function() {}
        )
    };
    t.version = "1.32.3"
...
ace.define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(e, t, n) {
    ...
    t.addCommandKeyListener = function(e, n, r) {
        ...
        c(e, "keydown", function(e) {
            ...
            return i = e.defaultPrevented,
            t
        }, r),
        c(e, "keypress", function(e) {
            i && (e.ctrlKey || e.altKey || e.shiftKey || e.metaKey) && (t.stopEvent(e),
            i = null)
        }, r),
...
ace.define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/config", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/clipboard", "ace/lib/keys"], function(e, t, n) {
    ...
    y = function(e, t) {
        ...
        function Y(e) {
            e.keyCode == 27 && n.value.length < n.selectionStart && (w || (N = n.value),
            C = k = -1,
            H()),
            G()
        }
        ...
        this.setAriaOptions = function(e) {
            e.activeDescendant ? (n.setAttribute("aria-haspopup", "true"),
            n.setAttribute("aria-autocomplete", e.inline ? "both" : "list"),
            n.setAttribute("aria-activedescendant", e.activeDescendant)) : (n.setAttribute("aria-haspopup", "false"),
        ...
        var B = function(e) {
          ...
          , j = function(e) {
            if (w)
                return;
            y ? y = !1 : B(n) ? (t.selectAll(),
            H()) : g && n.selectionStart != C && H()
        }
          , F = null;
        ...
        var I = !1
          , q = function(e, r) {
            ...
            E = !0;
            var d = !1;
            return s.isAndroid && f == ". " && (f = "  ",
            d = !0),
            f && !u && !a && !l && !c || x ? t.onTextInput(f) : t.onTextInput(f, {
                extendLeft: u,
                extendRight: a,
                restoreStart: l,
                restoreEnd: c
          ...
          , V = function(e) {
            ...
            if (a.pasteCancelled())
                return;
            typeof i == "string" ? (i && t.onPaste(i, e),
            s.isIE && setTimeout(H),
        ...
        var $ = function(e) {
            ...
            w.useTextareaForIME ? (N = n.value = "",
            C = 0,
            k = 0) : (n.msGetInputContext && (w.context = n.msGetInputContext()),
          ...
          , J = function() {
            ...
            if (w.useTextareaForIME)
                ...
                var e = n.value;
                q(e),
                w.markerRange && (w.context && (w.markerRange.start.column = w.selectionStart = w.context.compositionStartOffset),
                w.markerRange.end.column = w.markerRange.start.column + k - w.selectionStart + L)
            }
        }
          , K = function(e) {
...
ace.define("ace/lib/scroll", ["require", "exports", "module"], function(e, t, n) {
...
ace.define("ace/tooltip", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/range", "ace/lib/scroll"], function(e, t, n) {
    "use strict";
    ...
    var p = function(e) {
        function t(t) {
            ...
            var r = n.getElement();
            return r.style.whiteSpace = "pre-wrap",
        ...
        t.prototype.hide = function(e) {
            ...
            this.timeout = null,
            this.addMarker(null),
            this.isOpen && (this.$removeCloseEvents(),
...
ace.define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/tooltip", "ace/config"], function(e, t, n) {
    ...
    function f(e) {
        ...
        e.editor.setDefaultHandler("guttermousemove", function(t) {
            ...
            if (s.hasCssClass(n, "ace_fold-widget"))
                return f();
            r.isOpen && e.$tooltipFollowsMouse && c(t),
            u = t;
            if (i)
                return;
            i = setTimeout(function() {
                i = null,
                u && !e.isMousePressed ? a() : f()
            }, 50)
        }),
    ...
    var l = function(e) {
        ...
        t.prototype.showTooltip = function(e) {
            var n = this.editor.renderer.$gutterLayer, r = n.$annotations[e], i;
            r ? i = {
                text: Array.from(r.text),
            ...
            if (s && n.$showFoldedAnnotations) {
                ...
                if (u === "error_fold" || u === "warning_fold") {
                    var c = "".concat(t.annotationsToSummaryString(o), " in folded code.");
                    i.text.push(c),
                    i.type.push(u)
                }
            }
            ...
            for (var a = 0; a < i.text.length; a++) {
                var d = "<span class='ace_".concat(i.type[a], " ").concat(p, "' aria-label='").concat(t.annotationLabels[i.type[a].replace("_fold", "")].singular, "' role=img> </span> ").concat(i.text[a]);
                h[i.type[a].replace("_fold", "")].push(d)
            }
            var v = [].concat(h.error, h.warning, h.info).join("<br>");
            this.setHtml(v),
            this.$element.setAttribute("aria-live", "polite"),
            this.isOpen || (this.setTheme(this.editor.renderer.theme),
        ...
        t.annotationsToSummaryString = function(e) {
            var n, r, s = [], o = ["error", "warning", "info"];
            try {
        ...
        this.normalizeRules = function() {
            function i(s) {
                ...
                for (var u = 0; u < o.length; u++) {
                    ...
                    p && (p === "$self" && (p = "start"),
                    Array.isArray(p) ? f = p.map(function(e) {
                        return r[e]
                    }) : f = r[p]);
                    if (f) {
                        var d = [u, 1].concat(f);
    ...
    var r = e("./lib/lang")
      ...
      , s = function() {
        ...
        e.prototype.update = function(e, t, n, s) {
            ...
            for (var f = o; f <= u; f++) {
                var l = this.cache[f];
                l == null && (l = r.getMatchOffsets(n.getLine(f), this.regExp),
                ...
                for (var c = l.length; c--; ) {
                    ...
                    if (a[p])
                        continue;
                    a[p] = !0,
                    t.drawSingleLineMarker(e, h, this.clazz, s)
                }
            }
        }
        ,
    ...
    function s() {
        ...
        this.getMatchingBracketRanges = function(e, t) {
            var n = this.getLine(e.row)
              ...
              , o = s && s.match(r);
            o || (s = (t === undefined || t) && n.charAt(e.column),
            e = {
                row: e.row,
                column: e.column + 1
            },
...
ace.define("ace/edit_session", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/bidihandler", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/undomanager", "ace/edit_session/folding", "ace/edit_session/bracket_match"], function(e, t, n) {
    ...
    var r = e("./lib/oop")
      ...
      , v = function() {
        ...
        return e.prototype.setDocument = function(e) {
        ...
        e.prototype.$updateWrapData = function(e, t) {
            ...
            while (a <= t)
                ...
                .bind(this), u.end.row, n[u.end.row].length + 1),
                i[u.start.row] = this.$computeWrapSplits(o, s, r),
                a = u.end.row + 1) : (o = this.$getDisplayTokens(n[a]),
        ...
        e.prototype.$getDisplayTokens = function(e, t) {
            ...
            for (var i = 0; i < e.length; i++) {
                ...
                if (s == 9) {
                    ...
                    s == 32 ? n.push(E) : s > 39 && s < 48 || s > 57 && s < 64 ? n.push(w) : s >= 4352 && T(s) ? n.push(m, g) : n.push(m)
            }
            return n
        }
        ,
        e.prototype.$getStringScreenWidth = function(e, t, n) {
            ...
            for (i = 0; i < e.length; i++) {
                r = e.charCodeAt(i),
                r == 9 ? n += this.getScreenTabSize(n) : r >= 4352 && T(r) ? n += 2 : n += 1;
                if (n > t)
                    break
            }
            return [n, i]
      ...
      , o = function() {
        ...
        e.prototype.findAll = function(e) {
            ...
            if (n) {
                ...
                while (g < h && o[h].end.column > E && o[h].end.row == S)
                    h--;
                o = o.slice(g, h + 1);
                for (g = 0,
                h = o.length; g < h; g++)
    ...
    var r = e("./lib/dom")
      , i = function() {
        ...
        e.prototype.addLineWidget = function(e) {
            ...
            e.text && !e.el && (e.el = r.createElement("div"),
            ...
            if (e.keyCode === r.enter || e.keyCode === r.space) {
                ...
                case "fold":
                    if (this.gutterLayer.session.foldWidgets[this.$rowIndexToRow(this.activeRowIndex)] === "start") {
                        ...
                        setTimeout(function() {
                            this.$rowIndexToRow(this.activeRowIndex) !== t && (this.$blurFoldWidget(this.activeRowIndex),
...
ace.define("ace/editor", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/line_widgets", "ace/keyboard/gutter_handler", "ace/config", "ace/clipboard", "ace/lib/keys"], function(e, t, n) {
    ...
    var r = this && this.__values || function(e) {
      ...
      , N = function() {
        function e(t, n, r) {
            ...
            typeof document == "object" && (this.textInput = new a(t.getTextAreaContainer(),this),
        ...
        e.prototype.autoIndent = function() {
            ...
            for (var h = n; h <= r; h++)
                ...
                a = e.getLine(h),
                f = t.$getIndent(a),
                u !== f && (f.length > 0 && (l = new d(h,0,h,f.length),
                e.remove(l)),
                u.length > 0 && e.insert({
                    row: h,
                    column: 0
        ...
        e.prototype.setGhostText = function(e, t) {
            this.session.widgetManager || (this.session.widgetManager = new w(this.session),
        ...
        e.prototype.transposeLetters = function() {
            ...
            i = new d(e.row,t - 1,e.row,t + 1)) : (r = n.charAt(t - 1) + n.charAt(t - 2),
        ...
        e.prototype.jumpToMatching = function(e, t) {
            ...
            do {
                if (o.value.match(/[{}()\[\]]/g))
                    ...
                    o.type.indexOf("tag-name") !== -1 && (isNaN(f[o.value]) && (f[o.value] = 0),
            ...
            if (u === "bracket") {
                ...
                if (p.compare(n.row, n.column) === 0) {
                    ...
                    m && (m.openTag.contains(n.row, n.column) ? (p = m.closeTag,
                    v = p.start) : (p = m.openTag,
                    m.closeTag.start.row === n.row && m.closeTag.start.column === n.column ? v = p.end : v = p.start))
                }
                v = v || p.start
            }
            v = p && p.cursor || v,
        ...
        e.prototype.find = function(e, t, n) {
            ...
            var r = this.selection.getRange();
            t.needle == null && (e = this.session.getTextRange(r) || this.$search.$options.needle,
    ...
    N.prototype.$toggleWordPairs = [["first", "last"], ["true", "false"], ["yes", "no"], ["width", "height"], ["top", "bottom"], ["right", "left"], ["on", "off"], ["x", "y"], ["get", "set"], ["max", "min"], ["horizontal", "vertical"], ["show", "hide"], ["add", "remove"], ["up", "down"], ["before", "after"], ["even", "odd"], ["in", "out"], ["inside", "outside"], ["next", "previous"], ["increase", "decrease"], ["attach", "detach"], ["&&", "||"], ["==", "!="]],
        ...
        enableKeyboardAccessibility: {
            set: function(e) {
                var t = {
                    ...
                    if (e.target == this.renderer.scroller && e.keyCode === T.enter) {
                        e.preventDefault();
                ...
                e ? (this.renderer.enableKeyboardAccessibility = !0,
                this.renderer.keyboardFocusClassName = "ace_keyboard-focus",
                this.textInput.getElement().setAttribute("tabindex", -1),
                this.textInput.setNumberOfExtraLines(u.isWin ? 3 : 0),
                this.renderer.scroller.setAttribute("tabindex", 0),
                this.renderer.scroller.setAttribute("role", "group"),
                this.renderer.scroller.setAttribute("aria-roledescription", S("editor")),
                this.renderer.scroller.classList.add(this.renderer.keyboardFocusClassName),
                this.renderer.scroller.setAttribute("aria-label", S("Editor content, press Enter to start editing, press Escape to exit")),
                this.renderer.scroller.addEventListener("keyup", n.bind(this)),
                this.commands.addCommand(t),
                this.renderer.$gutter.setAttribute("tabindex", 0),
                this.renderer.$gutter.setAttribute("aria-hidden", !1),
                this.renderer.$gutter.setAttribute("role", "group"),
                this.renderer.$gutter.setAttribute("aria-roledescription", S("editor")),
                this.renderer.$gutter.setAttribute("aria-label", S("Editor gutter, press Enter to interact with controls using arrow keys, press Escape to exit")),
                this.renderer.$gutter.classList.add(this.renderer.keyboardFocusClassName),
                this.renderer.content.setAttribute("aria-hidden", !0),
                r || (r = new E(this)),
                r.addListener()) : (this.renderer.enableKeyboardAccessibility = !1,
                ...
                this.renderer.scroller.removeEventListener("keyup", n.bind(this)),
      ...
      , f = function() {
        ...
        e.prototype.update = function(e) {
            ...
            for (; ; ) {
                ...
                o = this.$lines.get(++u),
                o ? o.row = a : (o = this.$lines.createCell(a, e, this.session, l),
                this.$lines.push(o)),
        ...
        e.prototype.$renderCell = function(e, t, n, i) {
            var s = e.element
              ...
              , y = t.lineHeight + "px"
              , b = this.$useSvgGutterIcons ? "ace_gutter-cell_svg-icons " : "ace_gutter-cell "
              , w = this.$useSvgGutterIcons ? "ace_icon_svg" : "ace_icon"
              , E = (v ? v.getText(o, i) : i + h).toString();
            this.$highlightGutterLine && (i == this.$cursorRow || n && i < this.$cursorRow && i >= g && this.$cursorRow <= n.end.row) && (b += "ace_gutter-active-line ",
            ...
            p[i] && (b += p[i]),
            d[i] && (b += d[i]),
            this.$annotations[i] && i !== g && (b += this.$annotations[i].className);
            if (m) {
                var S = m[i];
            ...
            if (S) {
                ...
                L ? f.setAttribute("aria-label", a("Toggle code folding, rows $0 through $1", [L.start.row + 1, L.end.row + 1])) : n ? f.setAttribute("aria-label", a("Toggle code folding, rows $0 through $1", [n.start.row + 1, n.end.row + 1])) : f.setAttribute("aria-label", a("Toggle code folding, row $0", [i + 1])),
                T ? (f.setAttribute("aria-expanded", "false"),
                f.setAttribute("title", a("Unfold code"))) : (f.setAttribute("aria-expanded", "true"),
                f.setAttribute("title", a("Fold code")))
            } else
                f && (r.setStyle(f.style, "display", "none"),
                f.setAttribute("tabindex", "0"),
                f.removeAttribute("role"),
                f.removeAttribute("aria-label"));
            return C && this.$showFoldedAnnotations ? (l.className = "ace_gutter_annotation",
            c.className = w,
            c.className += N,
            r.setStyle(c.style, "height", y),
            r.setStyle(l.style, "display", "block"),
            r.setStyle(l.style, "height", y),
            l.setAttribute("aria-label", a("Read annotations row $0", [E])),
            l.setAttribute("tabindex", "-1"),
            l.setAttribute("role", "button")) : this.$annotations[i] ? (l.className = "ace_gutter_annotation",
            c.className = w,
            this.$useSvgGutterIcons ? c.className += this.$annotations[i].className : s.classList.add(this.$annotations[i].className.replace(" ", "")),
            r.setStyle(c.style, "height", y),
            r.setStyle(l.style, "display", "block"),
            r.setStyle(l.style, "height", y),
            l.setAttribute("aria-label", a("Read annotations row $0", [E])),
            l.setAttribute("tabindex", "-1"),
            l.setAttribute("role", "button")) : (r.setStyle(l.style, "display", "none"),
            ...
            e.text = E,
            l.style.display === "none" && f.style.display === "none" ? e.element.setAttribute("aria-hidden", !0) : e.element.setAttribute("aria-hidden", !1),
            e
        }
        ,
        e.prototype.setHighlightGutterLine = function(e) {
...
ace.define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter", "ace/config", "ace/layer/text_util"], function(e, t, n) {
    ...
    var r = e("../lib/oop")
      ...
      , l = function() {
        ...
        ,
        e.prototype.setHighlightIndentGuides = function(e) {
            return this.$highlightIndentGuides === e ? !1 : (this.$highlightIndentGuides = e,
            e)
        }
        ,
        ...
        e.prototype.$renderToken = function(e, t, n, r) {
            ...
            if (!f(n.type)) {
                ...
                n.type == "fold" && (b.style.width = n.value.length * this.config.characterWidth + "px",
                b.setAttribute("title", a("Unfold code"))),
                b.className = w,
                b.appendChild(u),
                e.appendChild(b)
            } else
...
ace.define("ace/scrollbar", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/event_emitter"], function(e, t, n) {
    ...
    var l = function(e) {
        function t(t, n) {
            ...
            r.inner.style.width = r.element.style.width = (r.width || 15) + 5 + "px",
            r.$minWidth = 0,
            r
        }
        return r(t, e),
    ...
    var c = function(e) {
        function t(t, n) {
            ...
            return r.scrollLeft = 0,
            r.height = n.$scrollbarWidth,
            r.inner.style.height = r.element.style.height = (r.height || 15) + 5 + "px",
            r
        }
        return r(t, e),
        t.prototype.onScroll = function() {
...
ace.define("ace/scrollbar_custom", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/event_emitter"], function(e, t, n) {
    ...
    var f = function(e) {
        function t(t, n) {
            ...
            r.renderer = n,
            r.inner.style.width = r.element.style.width = (r.width || 15) + "px",
            r.$minWidth = 0,
            r
        }
        return r(t, e),
    ...
    var l = function(e) {
        function t(t, n) {
            ...
            r.inner.style.height = r.element.style.height = (r.height || 12) + "px",
            r.renderer = n,
            r
        }
        return r(t, e),
    ...
    var r = e("../lib/oop")
      ...
      , h = function() {
        ...
        e.prototype.$getZoom = function(e) {
            return !e || !e.parentElement ? 1 : (window.getComputedStyle(e).zoom || 1) * this.$getZoom(e.parentElement)
        }
        ,
...
ace.define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/config", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/scrollbar", "ace/scrollbar_custom", "ace/scrollbar_custom", "ace/renderloop", "ace/layer/font_metrics", "ace/lib/event_emitter", "ace/css/editor-css", "ace/layer/decorators", "ace/lib/useragent"], function(e, t, n) {
    ...
    var E = function() {
        ...
        e.prototype.$renderChanges = function(e, t) {
            ...
            this.enableKeyboardAccessibility && (this.scroller.className += this.keyboardFocusClassName));
        ...
        e.prototype.scrollCursorIntoView = function(e, t, n) {
            ...
            this.session.setScrollLeft(i)) : (i += l,
            f + this.$size.scrollerWidth < i + this.characterWidth ? this.session.setScrollLeft(Math.round(i + this.characterWidth - this.$size.scrollerWidth)) : f <= this.$padding && i - f < this.characterWidth && this.session.setScrollLeft(0))
        }
        ,
        e.prototype.getScrollTop = function() {
        ...
        e.prototype.setGhostText = function(e, t) {
            ...
            if (i.length > 1) {
                ...
                if (f)
                    return;
                a < u ? this.scrollBy(0, (i.length - 1) * this.lineHeight) : this.scrollBy(0, s.top)
            }
        }
        ,
        e.prototype.removeGhostText = function() {
            ...
            this.removeExtraToken(e.row, e.column),
            this.$ghostTextWidget && (this.session.widgetManager.removeLineWidget(this.$ghostTextWidget),
        ...
        e.prototype.$updateCustomScrollbar = function(e) {
            ...
            e === !0 ? (this.scrollBarV = new d(this.container,this),
    ...
    o.defineOptions(E.prototype, "renderer", {
        useResizeObserver: {
            set: function(e) {
                !e && this.$resizeObserver ? (this.$resizeObserver.disconnect(),
                this.$resizeTimer.cancel(),
                this.$resizeTimer = this.$resizeObserver = null) : e && !this.$resizeObserver && this.$addResizeObserver()
            }
        },
        animatedScroll: {
            initialValue: !1
...
ace.define("ace/ext/error_marker", ["require", "exports", "module", "ace/line_widgets", "ace/lib/dom", "ace/range", "ace/config"], function(e, t, n) {
    ...
    t.showErrorMarker = function(e, t) {
        ...
        if (l) {
            var h = l[0];
            s.column = (h.pos && typeof h.column != "number" ? h.pos.sc : h.column) || 0,
            s.row = h.row,
