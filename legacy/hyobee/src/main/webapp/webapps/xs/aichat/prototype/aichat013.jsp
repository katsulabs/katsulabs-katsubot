...
<head>
    ...
    <!-- [S][기술원] 그리드 테스트 -->
    <!-- <script defer src="${pageContext.request.contextPath}/html/xs/aichat/js/prototype/aichat013.js?version=<%=System.currentTimeMillis() %>"></script> -->
    <!--// [E][기술원] 그리드 테스트 -->
    <!-- 화면CSS -->
                        ...
                        <div class="list-view navigation-list" id="chatHistory">
                            ...
                            <div class="list-view2-item on">
                                ...
                                <div class="list-view2 on" chat_category="internal_rules">
                                    <div class="text-area">aichat013.jsp</div>
                                </div>
                            </div>
                ...
                <div class="current-user">
                    <div class="current-user__content --theme0" style="--firstName: &quot;A&quot;;">
                        <div class="current-user__key">
                            <p class="current-user__name">aichat013.jsp</p>
                            <p class="current-user__position">aichat013.jsp</p>
                        </div>
                        <div class="current-user__value">
                            <p class="current-user__affiliate">aichat013.jsp</p>
                        </div>
                    </div>
