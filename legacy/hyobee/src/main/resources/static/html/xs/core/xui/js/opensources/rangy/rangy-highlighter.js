...
(function(factory, root) {
    ...
    rangy.createModule("Highlighter", ["ClassApplier"], function(api, module) {
        ...
        Highlighter.prototype = {
            ...
            /*HSITX*/
            removeClassApplier: function(classApplierName){
            	if(this.classAppliers.hasOwnProperty(classApplierName)){
            		delete this.classAppliers[classApplierName];
            	}
            },
            
            changeApplierClassName: function(oldClassApplierName, newClassApplierName){
            	if(this.classAppliers.hasOwnProperty(oldClassApplierName)){
            		this.classAppliers[oldClassApplierName].className	= newClassApplierName;
            	}
            },
            /**/
