...
(function(factory) {
    ...
    var NiceScrollClass = function(myopt, me) {
        ...
        this.body = $body;
        //this.viewport = false;
        this.viewport = (!opt.viewport ? false : $(opt.viewport));
        ...
        this.updateScrollBar = function(len) {
            ...
            if (self.ishwscroll) {
                ...
                */
            	/*HSITX*/
            	if(xuic.__BROWSER_NAME !== "MSIE"){
            		var wpos = null;
                	if(self.isfixed){
                		var dhxpopup		= null;
                		var viewport		= self.viewport[0];
                		while(viewport instanceof Element){
                			if(viewport.className.indexOf("dhx_popup") >= 0){
                				dhxpopup	= viewport;
                				break;
                			}
                	...
                	if(dhxpopup !== null){
                		var popupRect		= dhxpopup.getBoundingClientRect(); 
                		wpos				= self.getOffset();
                		wpos.top			= wpos.top - popupRect.top;
                		wpos.left			= wpos.left - popupRect.left;
        ...
        this.init = function() {
            ...
            if (!self.ispage || !cap.isieold) {
                ...
                if (opt.horizrailenabled) {
                    ...
                    railh.height = Math.max(parseFloat(opt.horizcursorheight), cursor.outerHeight());
                    railh.css({
                ...
                if (self.ispage) {
                    ...
                    if (self.ishwscroll) {
                        ...
                        self.isfixed = (!opt.viewport ? false : true);
        ...
        this.showRailHr = function() {
            if (self.railh) {
                if ((self.page.maxw !== 0) && (self.ispage || self.win.css('display') != 'none')) {
                    ...
                    self.railh.css('opacity', opt.cursoropacitymax);
                }
            }
            return self;
        };
