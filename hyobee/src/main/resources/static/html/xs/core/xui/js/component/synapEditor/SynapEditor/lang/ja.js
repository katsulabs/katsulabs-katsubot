(function () {
    var messages = {
        ...
        "message.alert.alreadyRegisteredShortcut": "ショートカット #{shortcut} はすでに登録されており、新たに追加できません。",
        ...
        "message.alert.cannotInsertTableOfContents": "目次を挿入できません。",
        ...
        "message.alert.invalidParaTagName": "#{tagName} タグはパラグラフタグとして設定できません。",
        "message.alert.invalidSourceCode": "無効なソースコードです。",
        "message.alert.minMaxHeightInvalid": "最小高さは最大高さより大きくすることはできません。",
        "message.alert.minMaxWidthInvalid": "最小幅は最大幅より大きくすることはできません。",
        "message.alert.nestedForm": "Form をネストすることはできません。",
        "message.alert.noContents": "選択範囲内の文書の内容が欠落しています",
        "message.alert.noTableOfContents": "挿入する目次はありません。",
        "message.alert.noUpdateTableOfContents": "更新する目次がありません。",
        ...
        "message.error.cellWrongRangeError": "セル範囲が無効です。<br>正しい形式で入力してください。<br>ex) A1, B2 or A1:B2",
        ...
        "message.label.addMemo": "コメントを追加",
        "message.label.additionalOptions": "追加オプション",
        ...
        "message.label.cellImportAreaTableDesc": "インポート範囲設定 - シート選択とセル範囲入力リスト",
        ...
        "message.label.codeBlock": "コードブロック",
        "message.label.colorPicker": "カラーピッカー",
        "message.label.columnWidthEqual": "列の幅を揃える",
        "message.label.comment": "コメント",
        "message.label.complete": "完了",
        "message.label.completed": "完了",
        "message.label.conditionalFormatting": "条件付き書式",
        "message.label.conditionalFormattingList": "条件付き書式リスト",
        "message.label.conditionalFormattingPlaceholder": "値または数式",
        "message.label.conditionalFormattingRuleBeginsWith": "開始テキスト",
        "message.label.conditionalFormattingRuleBetween": "間にある",
        "message.label.conditionalFormattingRuleContainsBlanks": "空です",
        "message.label.conditionalFormattingRuleContainsText": "テキストを含む",
        "message.label.conditionalFormattingRuleDate": "日付",
        "message.label.conditionalFormattingRuleEndsWith": "終了テキスト",
        "message.label.conditionalFormattingRuleEqual": "等しい",
        "message.label.conditionalFormattingRuleFormula": "数式",
        "message.label.conditionalFormattingRuleGreaterThan": "より大きい",
        "message.label.conditionalFormattingRuleGreaterThanOrEqual": "より大きいか等しい",
        "message.label.conditionalFormattingRuleLastMonth": "先月",
        "message.label.conditionalFormattingRuleLastWeek": "先週",
        "message.label.conditionalFormattingRuleLastYear": "昨年",
        "message.label.conditionalFormattingRuleLessThan": "より小さい",
        "message.label.conditionalFormattingRuleLessThanOrEqual": "より小さいか等しい",
        "message.label.conditionalFormattingRuleNextMonth": "来月",
        "message.label.conditionalFormattingRuleNextWeek": "来週",
        "message.label.conditionalFormattingRuleNextYear": "来年",
        "message.label.conditionalFormattingRuleNotBetween": "間にない",
        "message.label.conditionalFormattingRuleNotContainsBlanks": "空ではありません",
        "message.label.conditionalFormattingRuleNotContainsText": "テキストを含まない",
        "message.label.conditionalFormattingRuleNotEqual": "等しくありません",
        "message.label.conditionalFormattingRuleSpecificDate": "基準日",
        "message.label.conditionalFormattingRuleTextIsExactly": "テキストが正確に一致します",
        "message.label.conditionalFormattingRuleThisMonth": "今月",
        "message.label.conditionalFormattingRuleThisWeek": "今週",
        "message.label.conditionalFormattingRuleThisYear": "今年",
        "message.label.conditionalFormattingRuleToday": "今日",
        "message.label.conditionalFormattingRuleTomorrow": "明日",
        "message.label.conditionalFormattingRuleYesterday": "昨日",
        ...
        "message.label.decorativeImageDesc": "装飾用画像は、情報を伝える目的がなく、単にデザインのために使用されます。 選択すると、スクリーンリーダーで読み上げられなくなります。",
        "message.label.decreaseIndent": "インデントを減らす",
        "message.label.defaultKey": "デフォルトキー",
        "message.label.defaultKeyDesc": "主要なショートカット - 操作とショートカットキーの一覧",
        "message.label.delete": "削除",
        ...
        "message.label.notCompleted": "完了しない",
        ...
        "message.label.removeTableStyle": "表書式クリア",
        "message.label.removeTextStyle": "テキスト書式の消去",
        "message.label.reopen": "再オープン",
        ...
        "message.label.selectCellRange": "セル範囲を選択",
        ...
        "message.label.tableOfContents": "目次",
        ...
        "message.label.updateTableOfContents": "目次の更新",
        ...
        "message.template.addConditionalFormattingRule": "別のルールを追加",
        ...
        "message.template.clearButtonCol": "範囲クリアボタン列",
        "message.template.close": "閉じる",
        "message.template.colorPicker": "カラーピッカー",
        "message.template.comment": "コメント",
        "message.template.company": "会社名",
        "message.template.completed": "完了",
        "message.template.conditionalFormatting": "条件付き書式",
        "message.template.conditionalFormattingList": "条件付き書式リスト",
        "message.template.conditionalFormattingRange": "書式の範囲",
        "message.template.conditionalFormattingRule": "書式のルール",
        "message.template.conditionalFormattingRuleDescription": "セルの書式を指定する場合",
        "message.template.conditionalFormattingStyle": "書式のスタイル",
        ...
        "message.template.decorativeImage": "装飾用画像",
        ...
        "message.template.export": "エクスポート",
        "message.template.exportFileFormat": "ファイル形式",
        "message.template.exportFileName": "ファイル名",
        ...
        "message.template.memoPlaceholder": "コメントを記入してください。",
        ...
        "message.template.resolved": "解決済み",
        ...
        "message.template.selectCellRange": "セル範囲を選択",
        ...
        "message.template.sheetSelectCol": "シート選択チェックボックス列",
        ...
        "message.warning.layerHeightAboveMax": "現在の高さが設定した最大値を超えています。マウスを離すと、最大高さの設定が解除され、現在のサイズが適用されます。",
        "message.warning.layerHeightBelowMin": "現在の高さが設定した最小値を下回っています。マウスを離すと、最小高さの設定が解除され、現在のサイズが適用されます。",
        "message.warning.layerWidthAboveMax": "現在の幅が設定した最大値を超えています。マウスを離すと、最大幅の設定が解除され、現在のサイズが適用されます。",
        "message.warning.layerWidthBelowMin": "現在の幅が設定した最小値を下回っています。マウスを離すと、最小幅の設定が解除され、現在のサイズが適用されます。"
    };
