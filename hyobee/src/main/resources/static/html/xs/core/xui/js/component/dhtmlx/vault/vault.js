...
(function (DataEvents) {
    ...
    DataEvents["beforeRemoveAll"] = "beforeremoveall";
...
var DataCollection = /** @class */ (function () {
    ...
    DataCollection.prototype.removeAll = function () {
    	/*이정원*/
    	var objFileList = [];
    	$.each(this._pull, function(strFileId, objFile){
    		objFileList.push(objFile);
    	});
    	if(!this.events.fire(types_1.DataEvents.beforeRemoveAll, [objFileList])){
    		return;
    	}
        this._removeAll();
...
var Vault = /** @class */ (function (_super) {
    ...
    function Vault(container, config, baseOption) {
        if (config === void 0) { config = {}; }
    ...
    Vault.prototype._initUI = function (container) {
        ...
        if(_this.baseOption.upload && _this.baseOption.dnd){
        	cfg.on = this._getDragEvents();
        }
        ...
        if (file.status !== types_1.FileStatus.failed && file.link) {
            ...
            */
            ...
            var download = dom_1.el("a", {
                ...
                href: "#",
                onclick:function(e){
                	_this.events.fire("Download", [file, false]);
                }
            }, [
                dom_1.el(".icon-btn.dxi.dxi-download.action-download")
            ]);
...
var Uploader = /** @class */ (function () {
    function Uploader(config, data, events) {
        ...
        this._fileInput.id = "dhxVaultFile";
    ...
    Uploader.prototype.send = function (params) {
        ...
        /*이정원*/
        if(!_this.events.fire(types_1.UploaderEvents.beforeUploadFile, [all])){
        	return;
        }
        var files = all;
        /*
    ...
    Uploader.prototype._createFormData = function (fileWrappers, params) {
        ...
        */
        ...
        for (var _i = 0, fileWrappers_4 = fileWrappers; _i < fileWrappers_4.length; _i++) {
            var fileWrapper = fileWrappers_4[_i];
            formData.append(fieldName + brackets, fileWrapper.file, fileWrapper.file.name);
            objFileInfo.push({"fileId":fileWrapper.id, "fileName":fileWrapper.file.name});
        }
        var strRequestParams = this.events.context.baseOption.onBeforeRequest.call("", objFileInfo);
        formData.append("jsonData", strRequestParams);
        return formData;
    };
