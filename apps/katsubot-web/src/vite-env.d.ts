...
interface ImportMetaEnv {
  ...
  /** Vite dev proxy — chat-api (auth·chat-api-only 모드, default http://localhost:8081) */
  ...
  /** Vite dev proxy — /api/v1 대화·메시지 (default legacy :8080). chat-api만: http://localhost:8081 */
