...
| DoD | Strangler cutover · katsubot-web 단일 진입 · legacy read-only |
...
| ID | 작업 | 담당 | 상태 |
|----|------|------|------|
| 4-O1 | Strangler `/` → katsubot-web SPA | Infra/QA | 진행 |
| 4-O2 | katsubot-web Docker·nginx SPA | Frontend/Infra | 진행 |
...
| [Frontend] | `katsubot-web/Dockerfile`, SPA nginx |
