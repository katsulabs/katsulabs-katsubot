...
class DeleteConversationsUseCaseTest {
    ...
    private static final class InMemoryConversationRepository implements ConversationRepository {
        private final com.katsulabs.katsubot.infrastructure.persistence.InMemoryConversationRepository delegate =
                new com.katsulabs.katsubot.infrastructure.persistence.InMemoryConversationRepository();
